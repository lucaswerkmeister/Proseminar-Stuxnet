...
\begin{frame}
  ...
  \end{itemize}
  \note{Dampfkochtopf-Analogie?LF21 Sekunden replayLFbei Pressure controllers, die Dump Line kontrollieren, wird Linearisierungs-Kalibrierung ueberschossen}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Manipulation der Rotorgeschwindigkeit
      ...
      \end{itemize}
    \item Leicht festzustellen (zuhören) – insbesondere, da synchronisiert
  \end{itemize}
  \note{Es werden NICHT alte Sensordaten abgespielt! Unnoetig: Konst. Geschw. erwartet, ausserdem SCADA liest Daten aus Speicher, nicht direkt aus Geraet.LFAngriff wurde vmtl. via WinCC synchronisiert, noch leichter zu hoeren}
\end{frame}
