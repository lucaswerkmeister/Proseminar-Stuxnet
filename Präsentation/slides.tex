...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Peer-to-Peer Updates
      ...
      \end{itemize}
  \end{itemize}
  \note{Domains mittlerweile alle Besitzer gewechseltLFRPC = Remote Procedure Call}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item CVE-2010-2743: https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2010-2743
