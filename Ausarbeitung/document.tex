...
Als wahrscheinlichster Urheber gelten die USA.
...
Diese PLCs werden durch die Siemens-Software \emph{Step7} programmiert.
...
Dies wird dadurch noch verstärkt, dass Stuxnet versucht, über ein infiziertes WinCC-System (falls vorhanden) den Angriff über mehrere PLCs hinweg zu synchronisieren.
...
Gleichzeitig legten die Entwickler geringeren Wert darauf, nicht entdeckt zu werden.
