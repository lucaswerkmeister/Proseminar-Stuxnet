...
\subsection{1. Angriff: Ventile, Gasdruck}
...
\begin{figure}
  \begin{adjustwidth}{-3cm}{+3cm}
    \subfloat[Ausgenutzte Sicherheitslücken]{
      \includegraphics[width=10cm]{../Evolution_exploits.pdf}
    }
    \subfloat[Verbreitungswege]{
      \includegraphics[width=7cm]{../Evolution_replication.pdf}
    }
  \end{adjustwidth}
